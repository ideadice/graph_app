        ...
        tooltips: {
          ...
          callbacks: {
            ...
            label: function(tooltipItems, data) { 
              var multistringText = ["Lock Rate: " + currency + fixCommas(tooltipItems.yLabel)];
                  ...
                  document.getElementById("weekLockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                  document.getElementById("weekPrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                  document.getElementById("weekOpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
        ...
        callbacks: {
          ...
          label: function(tooltipItems, data) { 
            var multistringText = ["Lock Rate: " + currency + fixCommas(tooltipItems.yLabel)];
                ...
                document.getElementById("monthLockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                document.getElementById("monthPrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                document.getElementById("monthOpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
      ...
      tooltips: {
        ...
        callbacks: {
          ...
          label: function(tooltipItems, data) { 
            ...
            multistringText.push("Lock Rate: " + currency + fixCommas(tooltipItems.yLabel));
                //multistringText.push('Previous Close: $' + fixCommas(prevClose_data[tooltipItems.index]));
                //multistringText.push('Opening Rate: $' + fixCommas(openingRate_data[tooltipItems.index]));
                //multistringText.push('Daily High: $' + fixCommas(dailyHigh_data[tooltipItems.index]));
                //multistringText.push('Daily Low: $' + fixCommas(dailyLow_data[tooltipItems.index]));
                ...
                document.getElementById("month3LockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                document.getElementById("month3PrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                document.getElementById("month3OpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
        ...
        callbacks: {
          ...
          label: function(tooltipItems, data) { 
            ...
            multistringText.push("Lock Rate: " + currency + fixCommas(tooltipItems.yLabel));
                ...
                document.getElementById("month6LockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                document.getElementById("month6PrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                document.getElementById("month6OpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
        ...
        callbacks: {
          ...
          label: function(tooltipItems, data) { 
            //var multistringText = ["Lock Rate: $" + fixCommas(tooltipItems.yLabel)];
                ...
                document.getElementById("yearLockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                document.getElementById("yearPrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                document.getElementById("yearOpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
        ...
        callbacks: {
          ...
          label: function(tooltipItems, data) { 
            ...
            multistringText.push("Lock Rate: " + currency + fixCommas(tooltipItems.yLabel));
                ...
                document.getElementById("year3LockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
                document.getElementById("year3PrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
                document.getElementById("year3OpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
      ...
      callbacks: {
        ...
        label: function(tooltipItems, data) { 
          ...
          multistringText.push("Lock Rate: " + currency + fixCommas(tooltipItems.yLabel));
              ...
              document.getElementById("year5LockRate").innerHTML = 'Lock Rate: ' + currency + fixCommas(tooltipItems.yLabel);
              document.getElementById("year5PrevClose").innerHTML = 'Previous Close: ' + currency + fixCommas(prevClose_data[tooltipItems.index]);
              document.getElementById("year5OpeningRate").innerHTML = 'Opening Rate: ' + currency + fixCommas(openingRate_data[tooltipItems.index]);
      ...
      callbacks: {
        ...
        label: function(tooltipItems, data) { 
          var multistringText = ["Rate: " + currency + fixCommas(tooltipItems.yLabel)];
              ...
              document.getElementById("dailyRate").innerHTML = 'Rate: ' + currency + fixCommas(tooltipItems.yLabel);
              ...
              document.getElementById("dailyBaseRate").innerHTML = 'Base Rate: ' + currency + fixCommas(baseRate_data[tooltipItems.index]);
