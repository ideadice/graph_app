...
function createChartWeek(dataset){
        ...
        //document.getElementById("debug1").innerHTML = "-- Into Week chart";
        //document.getElementById("debug2").innerHTML = "x data Week:" + x_data;
        //document.getElementById("debug3").innerHTML = "y data Week:" + y_data;
...
function createChartMonth(dataset){
  ...
  //document.getElementById("debug5").innerHTML = "Into createChartMonth()";
    //x axis values
    ...
    //document.getElementById("debug6").innerHTML = "Into Month chart";
    //document.getElementById("debug7").innerHTML = "x data Month:" + x_data;
    //document.getElementById("debug8").innerHTML = "y data Month:" + y_data;
...
function createChartDaily(dataset){
  ...
  //document.getElementById("debug5").innerHTML = "x data Daily:" + x_data;
  //document.getElementById("debug6").innerHTML = "y data Daily:" + y_data;
  //document.getElementById("debug7").innerHTML = "Data set daily:" + dataset;
