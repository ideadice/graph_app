...
app.controller('mainController', function ($scope) {
    $scope.showval = false;
    $scope.hideval = true;  //to hide - true
    $scope.hideval2 = false;    //to show - false, to hide - true
    ...
    $scope.showHideFunc = function (param) {
        ...
        if (param == "showWeek") {
            ...
            var chart3yInterval = setInterval(timer3y, 300);
            function timer3y() {
                chart3yearLoader.style.display = 'none';
            ...
            var chart5yInterval = setInterval(timer5y, 400);
            function timer5y() {
                chart5yearLoader.style.display = 'none';
