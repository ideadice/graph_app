...
//Month
intervalMonth = setInterval("getResultMonth()", 100);
...
//3Month
interval3Month = setInterval("getResult3Month()", 100);
...
//6Month
interval6Month = setInterval("getResult6Month()", 100);
...
//Year
intervalYear = setInterval("getResultYear()", 50);
...
//3 Year
interval3Year = setInterval("getResult3Year()", 100);
...
//5 Year
interval5Year = setInterval("getResult5Year()", 100);
...
//Daily
intervalDaily = setInterval("getResultDaily()", 100);
function getResultDaily()
{
    // once we get a result, turn interval off. 
 //document.getElementById("debug1").innerHTML = "Into getResultDaily()";
 if(json_obj_Daily != null)
  {
    intervalDaily = clearInterval(intervalDaily);
    //create json from the data

    //document.getElementById("debug2").innerHTML = "Into getResultDaily(), json_obj_Daily:" + json_obj_Daily;
